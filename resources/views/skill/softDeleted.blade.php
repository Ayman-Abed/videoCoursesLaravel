  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><span class="badge badge-danger">skill Table Deleted</span> </h1>
                  ...
                  <tbody>
                    ...
                    @foreach ($skills as $skill)
                        ...
                        <tr>
                          ...
                          <td>
                              <a  style="margin: 5px ; text-decoration: none;" href="{{ route('skill.restore',['id' =>$skill->id])}}">
                                  <i  style="color:blue;" class="fas fa-trash-restore"></i>
                              </a>
                              <a  style="margin: 5px; text-decoration: none;" href="{{ route('skill.hdelete',['id' =>$skill->id])}}">
