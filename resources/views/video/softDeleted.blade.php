                  ...
                  <tbody>
                    ...
                    @foreach ($videos as $video)
                        ...
                        <tr>
                          ...
                          <td>
                              <a  style="margin: 5px ; text-decoration: none;" href="{{ route('video.restore',['id' =>$video->id])}}">
                                  <i  style="color:blue;" class="fas fa-trash-restore"></i>
                              </a>
                              <a  style="margin: 5px; text-decoration: none;" href="{{ route('video.hdelete',['id' =>$video->id])}}">
