  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><span class="badge badge-primary">Category Table</span> </h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                  ...
                  <tbody>
                    ...
                    @foreach ($categories as $category)
                        ...
                        <tr>
                          ...
                          <td>
                              <a  style="margin: 5px ; text-decoration: none;" href="{{ route('category.edit',['id' => $category->id])}}">
                                  <i  style="color:blue;" class="fas fa-edit"></i>
                              </a>
                              <a  style="margin: 5px; text-decoration: none;" href="{{ route('category.deleteCategory',['id' => $category->id])}}">
