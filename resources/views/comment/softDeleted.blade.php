                  ...
                  <tbody>
                    ...
                    @foreach ($comments as $comment)
                        ...
                        <tr>
                          ...
                          <td>
                            <a  style="margin: 5px ; text-decoration: none;" href="{{ route('comment.restore',['id' =>$comment->id])}}">
                                <i  style="color:blue;" class="fas fa-trash-restore"></i>
                            </a>
                            <a  style="margin: 5px; text-decoration: none;" href="{{ route('comment.hdelete',['id' =>$comment->id])}}">
